...
namespace Shift.UnitTest
{
    ...
    public class DocumentDBJobClientAsyncTest
    {
        JobClient jobClient;
        private const string AppID = "TestAppID";

        public DocumentDBJobClientAsyncTest()
        {
            var appSettingsReader = new AppSettingsReader();

            //Configure storage connection
            var config = new ClientConfig();
            config.DBConnectionString = appSettingsReader.GetValue("DocumentDBUrl", typeof(string)) as string;
            config.DBAuthKey = appSettingsReader.GetValue("DocumentDBAuthKey", typeof(string)) as string;
            config.StorageMode = "documentdb";

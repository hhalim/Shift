...
**
**
** Purpose: Synchronous Event-based implementation of IProgress<T>.
** Modified from original Microsoft code: http://referencesource.microsoft.com/#mscorlib/system/progress.cs
** Based on this StackOverflow thread: http://stackoverflow.com/questions/17982555/iprogresst-synchronization
** Use a synchronous Send() instead of the async Post().
**
===========================================================*/
